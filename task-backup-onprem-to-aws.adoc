...
Si creas tus propios buckets, debes usar un nombre de bucket que empiece por «netapp-backup». Si necesita usar un nombre personalizado, edite las políticas utilizadas en la sección Configurar permisos S3 para usar un ARN de recursos que coincida con su propio prefijo de depósito personalizado.
