...
---
= Restaure bases de datos MongoDB, MySQL y PostgreSQL con la copia de seguridad y recuperación de BlueXP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Puede restaurar bases de datos MongoDB, MySQL y PostgreSQL en cualquier host con la copia de seguridad y recuperación de BlueXP.
