...
.Pasos
. En la página Policies, selecciona *Create new policy* > *Create snapshot policy*.
...
== Cree una política de replicación
...
.Pasos
. En la página Políticas, selecciona *Crear nueva política* > *Crear nueva política de replicación*.
...
== Cree una política de almacenamiento de backup en objetos
...
.Pasos
. En la página de administración de políticas, selecciona *Crear nueva política* > *Crear nueva política de copia de seguridad*.
. En la sección Policy Details, especifique el nombre de la política.
. Especifique las etiquetas de SnapMirror (máximo de 5) que indican la retención de cada etiqueta.
