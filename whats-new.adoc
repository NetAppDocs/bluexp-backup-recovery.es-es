...
=== 3-2-1 Creación de políticas durante la activación de la copia de seguridad

Anteriormente, había que crear políticas personalizadas antes de iniciar una snapshot, replicación o backup. A partir de ONTAP 9,8 P5, ahora puede crear una política durante el proceso de activación de backup mediante la IU de backup y recuperación de BlueXP.
...
=== Compatibilidad para restauraciones rápidas bajo demanda
...
El sistema de destino de Cloud Volumes ONTAP debe ejecutar ONTAP versión 9.13.0 o posterior.
...
El Job Monitor de backup y recuperación de BlueXP ahora muestra información acerca de los trabajos de restauración rápidos.
