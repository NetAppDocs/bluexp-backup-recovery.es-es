...
* Capacidad para realizar una «restauración rápida» de un volumen del almacenamiento en cloud a un sistema Cloud Volumes ONTAP; perfecto para situaciones de recuperación ante desastres en las que necesita proporcionar acceso a un volumen lo antes posible.
