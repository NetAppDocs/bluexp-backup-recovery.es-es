...
+
** En AWS, https://["Amazon Athena"^] y.. https://["Pegamento de AWS"^] Los recursos se implementan en un nuevo bloque de S3.
+
endif::aws[]
...
+
** En Azure, una https://["Espacio de trabajo de Azure Synapse"^] y.. https://["Almacenamiento de lagos de datos de Azure"^] se aprovisionan en su cuenta de almacenamiento para almacenar y analizar los datos.
+
endif::azure[]
...
* En Google, se pone en marcha un nuevo bloque y el https://["Servicios de Google Cloud BigQuery"^] se aprovisionan en el nivel de cuenta/proyecto.
