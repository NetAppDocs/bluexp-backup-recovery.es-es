...
Las copias de seguridad están asociadas a la  https://docs.netapp.com/us-en/bluexp-setup-admin/concept-netapp-accounts.html["Cuenta BlueXP"^] en el que reside el conector BlueXP .

Si tiene varios conectores en la misma cuenta de BlueXP , cada conector muestra la misma lista de copias de seguridad.
