...
.Pasos
. Complete el para crear una cuenta en la página de soporte de NetApp https://["Formulario de registro de usuarios del sitio de soporte de NetApp"^]
+
...
. Vaya a. https://["Sitio de registro de soporte de NetApp"^] Y seleccione *no soy un cliente registrado de NetApp*.
