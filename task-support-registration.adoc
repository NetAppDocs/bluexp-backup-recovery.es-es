...
+
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-family/main/media/screenshot-register-support.png["Captura de pantalla que muestra un número de serie de la cuenta y la opción Registrar para Soporte"]
