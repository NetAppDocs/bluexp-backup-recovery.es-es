...
* Tiene un conector instalado en Azure. El conector se puede instalar en un sitio con acceso completo a Internet ("modo estándar") o con conectividad limitada a Internet ("modo restringido"). .image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Dos"] Habilite Cloud Backup en su sistema nuevo o existente
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["Instalar el conector manualmente en un host Linux en una región de Azure"^]
