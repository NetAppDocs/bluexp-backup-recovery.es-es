...
[role="lead"]
El backup y recuperación de datos de BlueXP para máquinas virtuales ofrece funcionalidades de protección de datos al realizar backups de almacenes de datos que restauran máquinas virtuales.
