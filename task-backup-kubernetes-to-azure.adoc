...
+
--
* Ha descubierto el clúster de Kubernetes como entorno de trabajo de BlueXP. https://docs.netapp.com/us-en/bluexp-kubernetes/task/task-kubernetes-discover-azure.html["Descubra el clúster de Kubernetes"^].
...
--
Regiones de Azure compatibles:: El backup y la recuperación de BlueXP se admiten en todas las regiones de Azure https://cloud.netapp.com/cloud-volumes-global-regions["Donde se admite Cloud Volumes ONTAP"^].
