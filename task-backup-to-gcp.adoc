...
.Resultado
El backup y la recuperación de datos de BlueXP están habilitados en el sistema, realiza un backup del volumen que creó cada día y conserva las 30 copias de backup más recientes.
