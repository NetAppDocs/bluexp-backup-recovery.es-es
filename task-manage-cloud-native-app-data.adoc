...
summary: Puede visualizar los detalles del backup, supervisar el estado de todos los trabajos, eliminar clon, datos de auditoría, actualizar los detalles del conector, configurar certificados de CA, y gestione hosts. 
---
