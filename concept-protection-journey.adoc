...
Puede crear Snapshot, replicación y backup en políticas de almacenamiento de objetos en la interfaz de usuario de backup y recuperación de BlueXP . Consulte la sección para link:task-manage-backups-ontap.html#add-a-new-backup-to-cloud-policy["añada una nueva política de backup"] obtener más información.
...
* Puede realizar un backup de los datos de sistemas ONTAP en las instalaciones o sistemas Cloud Volumes ONTAP instalados en las regiones comerciales de AWS en Amazon S3. link:task-backup-to-s3.html["Realice backup de los datos de Cloud Volumes ONTAP en Amazon S3"].
...
* Puede realizar backup de datos de sistemas ONTAP en las instalaciones o sistemas Cloud Volumes ONTAP instalados en regiones comerciales de Azure en Azure Blob. link:task-backup-to-azure.html["Realice backups de los datos de Cloud Volumes ONTAP en Azure Blob"].
