...
---
= Administre las opciones de almacenamiento de copia de seguridad en objetos en la página Configuración avanzada de la copia de seguridad y recuperación de BlueXP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
