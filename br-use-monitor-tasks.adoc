...
La BlueXP backup and recovery conserva la información del trabajo durante 15 días, después de los cuales se elimina y ya no es visible en el Monitor de trabajos.
