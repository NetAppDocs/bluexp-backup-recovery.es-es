...
[NOTE]
====
Si está creando copias de seguridad en las regiones de AWS GovCloud o AWS China, deberá cambiar el nombre de recurso de AWS “arn” en todas las secciones _Resource_ en los conjuntos de permisos anteriores y siguientes:
