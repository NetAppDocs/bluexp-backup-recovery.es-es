...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html["Ponga en marcha un conector en AWS"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-restricted-mode.html["Instalar el conector manualmente en un host Linux en una región AWS"^]
