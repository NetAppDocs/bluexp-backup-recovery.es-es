...
Después de comprar tu licencia de backup y recuperación (Cloud Backup) de BlueXP, activa la licencia en BlueXP introduciendo el número de serie y la cuenta de NSS de backup y recuperación de BlueXP o cargando el archivo de licencia de NLF. Los pasos a continuación muestran cómo obtener el archivo de licencia de NLF si planea utilizar ese método.
