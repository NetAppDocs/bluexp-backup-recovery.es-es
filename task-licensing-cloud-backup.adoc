...
* AWS https://aws.amazon.com/marketplace/pp/prodview-oorxakq6lq7m4["Vaya a la oferta del mercado para los servicios inteligentes de NetApp para obtener información detallada sobre los precios"^]: .
...
* Azure https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Vaya a la oferta del mercado para los servicios inteligentes de NetApp para obtener información detallada sobre los precios"^]: .
...
* Google Cloud https://console.cloud.google.com/marketplace/details/netapp-cloudmanager/cloud-manager?supportedpurview=project["Vaya a la oferta del mercado para los servicios inteligentes de NetApp para obtener información detallada sobre los precios"^]: .
