...
[role="lead"]
Es posible supervisar el estado de los trabajos de backup que se iniciaron o programados, y los trabajos de restauración iniciados. Puede ver los trabajos completados, en curso o fallidos para poder diagnosticar y corregir problemas. Con el Centro de notificaciones de BlueXP, puedes habilitar el envío de notificaciones por correo electrónico para que se te informe de la actividad importante del sistema incluso sin haber iniciado sesión en el sistema. Gracias a la línea de tiempo de BlueXP, puedes ver detalles de todas las acciones que se han iniciado a través de la interfaz de usuario o la API.
...
. Para mostrar columnas adicionales (entorno de trabajo, SVM, nombre de usuario, carga de trabajo, nombre de política, Y Etiqueta de instantánea), seleccione image:button_plus_sign_round.png["el botón de signo más"].
...
El Centro de notificaciones muestra numerosos eventos de copia de seguridad y restauración, pero solo los siguientes eventos activan alertas por correo electrónico:
