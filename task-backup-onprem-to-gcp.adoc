...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Tres"] Prepare la conexión en red para el conector
[role="quick-margin-para"]
Asegúrese de que el conector tiene las conexiones de red necesarias.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Cuatro"] Verifique los requisitos de licencia
[role="quick-margin-para"]
Tendrás que comprobar los requisitos de licencias tanto para Google Cloud como para BlueXP.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinco"] Prepare los clústeres ONTAP
[role="quick-margin-para"]
...
De manera opcional, puede configurar sus propias claves gestionadas personalizadas para el cifrado de datos en lugar de utilizar las claves de cifrado de Google Cloud predeterminadas.
