...
* Ha descubierto el clúster en las instalaciones y lo ha añadido como entorno de trabajo en BlueXP. Consulte https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["Detección de clústeres de ONTAP"^] para obtener más detalles.
+
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html["Instalación de un conector en GCP"^]
