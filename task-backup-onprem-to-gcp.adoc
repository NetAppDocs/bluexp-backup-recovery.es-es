...
Elige si conectarás tu clúster local de ONTAP directamente a Google Cloud Storage a través de Internet pública, o si usarás una VPN o una interconexión de Google Cloud y enrutarás el tráfico a través de una interfaz privada de Google Access que use una dirección IP privada.
