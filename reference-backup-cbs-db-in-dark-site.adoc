...
. En el sistema host de Connector, cambie el directorio a «/opt/application/netapp/cbs».
...
. Copie el archivo zip de backup de Indexed Catalog desde la ubicación segura al nuevo host de Connector en la carpeta «/opt/application/netapp/cbs».
