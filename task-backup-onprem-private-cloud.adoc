...
* Si utiliza una arquitectura de backup ramificada, deben configurarse los siguientes ajustes en el sistema de almacenamiento principal.
* Cuando utiliza una arquitectura de backup en cascada, los siguientes ajustes deben configurarse en el sistema de almacenamiento secundario.
...
** *Fan Out*: La información fluye del primario al secundario _and_ del origen al almacenamiento de objetos.
+
